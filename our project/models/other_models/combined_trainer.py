...
MODEL = "mistroll"  # Model checkpoint on the Hugging Face Hub
DATASET = "NingLab/ECInstruct"  # Dataset on the Hugging Face Hub
DATA_COLUMN = "input_field"  # Column name containing the code content
