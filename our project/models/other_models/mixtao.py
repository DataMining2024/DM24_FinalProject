...
class Mixtao(ShopBenchBaseModel):
    """
    ...
    def __init__(self):
       ...
       # model_path = 'lmsys/vicuna-7b-v1.5'
        self.tokenizer = AutoTokenizer.from_pretrained('./models/mixtao/', trust_remote_code=True)
        self.model = AutoModelForCausalLM.from_pretrained('./models/mixtao/',  device_map='auto',
