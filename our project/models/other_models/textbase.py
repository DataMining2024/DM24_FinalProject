...
class TextBase(ShopBenchBaseModel):
    """
    ...
    def __init__(self):
       ...
       # model_path = 'lmsys/vicuna-7b-v1.5'
        self.tokenizer = AutoTokenizer.from_pretrained('./models/textbase/', trust_remote_code=True)
        self.model = AutoModelForCausalLM.from_pretrained('./models/textbase/',  device_map='auto',
