...
class Mistroll_Cats2(ShopBenchBaseModel):
    ...
    def predict(self, prompt: str, is_multiple_choice: bool) -> str:
        ...
        if is_multiple_choice:
            ...
            elif ("Which of the following product") or ("Select the category") in prompt:  # task 2
                prompt_edit = ("You should choose the option which fits best for the given attribute or product "
                          "type. \n") + prompt
                print("-------------------2---------------------")
            ...
            if "adequate title" in prompt:  # task 17
                prompt_edit = (
                ...
                prompt_edit = ("You will be given a product title in inverted commas. You have to translate it based on the "
                ...
                prompt_edit = ("You have to explain the given product category or type. Your answer should be "
                ...
                prompt_edit = (  "You will be given a product, which just has been bought. Now choose from the following product list EXACTLY 3 products, which are the closest to the given product.\n") + prompt
                print("-------------------14---------------------")
