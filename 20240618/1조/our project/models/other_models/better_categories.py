...
class VicunaCategory(ShopBenchBaseModel):
    """
    ...
    def __init__(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained('./models/vicuna-7b-v1.5/', trust_remote_code=True, do_sample=True)
        self.model = AutoModelForCausalLM.from_pretrained('./models/vicuna-7b-v1.5/', #quantize_config=None,
                                                         device_map='auto',
