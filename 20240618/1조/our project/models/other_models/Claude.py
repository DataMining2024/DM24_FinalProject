...
class Claude(ShopBenchBaseModel):
    """
    ...
    def __init__(self):
       ...
       # model_path = 'lmsys/vicuna-7b-v1.5'
        ...
        self.model = AutoModelForCausalLM.from_pretrained('./models/claude/',
                                                            hf=True, model_file="claude2-alpaca-13b.Q4_K_M.gguf", model_type="llama", gpu_layers=50)
        #self.tokenizer = AutoTokenizer.from_pretrained('./models/claude/')
        #self.model.to('cuda')
